	...
	public function metaboxesConfig( $metaboxes ) {
		...
		$featured_image_metaboxes = array(
			...
			'enhanced_featured_image' => array(
				...
				'title'      => esc_html__( 'Thumbnail', 'noto' )
								...
								. esc_html__( 'Thumbnail (Featured Image)', 'noto' )
								. '</title><p>'
								. esc_html__( 'The  image will be displayed on the Portfolio Grid as a thumbnail for the current project.', 'noto' )
								. '</p><p>'
								. '<strong>' . esc_html__( 'Thumbnail Hover', 'noto' ) . '</strong>'
								. '</p><p>'
								. esc_html__( 'Set an alternative background image when the mouse hovers the thumbnail. It will fill the thumbnail area and it will be vertical and horizontal centered.', 'noto' )
								. '</p>"></span>',
				...
				'fields'     => array(
					array(
						'name'          => esc_html__( 'Thumbnail Image', 'noto' ),
						'id'            => '_thumbnail_id', // this is the same id of the featured image we are replacing
						'type'          => 'image',
						'button_text'   => esc_html__( 'Add Thumbnail Image', 'noto' ),
						'class'         => '',
						'validate_func' => 'pixelgrade_featured_image_validate_thumbnail_id_field',
					),
					array(
						'name'        => esc_html__( 'Thumbnail Hover Image', 'noto' ),
						'id'          => '_thumbnail_hover_image',
						'type'        => 'image',
						'button_text' => esc_html__( 'Add Thumbnail Hover', 'noto' ),
