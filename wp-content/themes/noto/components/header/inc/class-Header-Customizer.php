...
class Pixelgrade_Header_Customizer extends Pixelgrade_Singleton {
	...
	public function addCustomifyOptions( $options ) {
		...
		$header_section = array(
			// Header
			'header_section' => array(
				'title'   => esc_html__( 'Header', 'noto' ),
				'options' => array(
					'header_options_customizer_tabs'  => array(
						'type' => 'html',
						'html' => '<nav class="section-navigation  js-section-navigation">
							<a href="#section-title-header-layout">' . esc_html__( 'Layout', 'noto' ) . '</a>
							<a href="#section-title-header-colors">' . esc_html__( 'Colors', 'noto' ) . '</a>
							<a href="#section-title-header-fonts">' . esc_html__( 'Fonts', 'noto' ) . '</a>
							</nav>',
					),
					...
					'header_title_layout_section'     => array(
						'type' => 'html',
						'html' => '<span id="section-title-header-layout" class="separator section label large">&#x1f4d0; ' . esc_html__( 'Layout', 'noto' ) . '</span>',
					),
					'header_logo_height'              => array(
						'type'        => 'range',
						'label'       => esc_html__( 'Logo Height', 'noto' ),
						'desc'        => esc_html__( 'Adjust the max height of your logo container.', 'noto' ),
						'live'        => true,
					...
					'header_height'                   => array(
						'type'        => 'range',
						'label'       => esc_html__( 'Header Height', 'noto' ),
						'desc'        => esc_html__( 'Adjust the header and navigation bar height.', 'noto' ),
						'live'        => true,
					...
					'header_navigation_links_spacing' => array(
						'type'        => 'range',
						'label'       => esc_html__( 'Navigation Link Spacing', 'noto' ),
						'desc'        => esc_html__( 'Adjust the spacing between individual items in your navigation.', 'noto' ),
						'live'        => true,
					...
					'header_position'                 => array(
						'type'    => 'select',
						'label'   => esc_html__( 'Header Position', 'noto' ),
						'desc'    => esc_html__( 'Choose if you want a static menu or a fixed (sticky) one that stays visible no matter how much you scroll the page.', 'noto' ),
						'default' => null, // this should be set by the theme (previously sticky)
						'choices' => array(
							'static' => esc_html__( 'Static', 'noto' ),
							'sticky' => esc_html__( 'Sticky (fixed)', 'noto' ),
						),
					),
					'header_width'                    => array(
						'type'    => 'select',
						'label'   => esc_html__( 'Header Width', 'noto' ),
						'desc'    => esc_html__( 'Choose if you want the header span to the full-browser or stay aligned with the site container width.', 'noto' ),
						'default' => null, // this should be set by the theme (previously full)
						'choices' => array(
							'full'      => esc_html__( 'Full Browser Width', 'noto' ),
							'container' => esc_html__( 'Container Width', 'noto' ),
						),
					),
					'header_sides_spacing'            => array(
						'type'        => 'range',
						'label'       => esc_html__( 'Header Sides Spacing', 'noto' ),
						'desc'        => esc_html__( 'Adjust the space separating the header and the sides of the browser.', 'noto' ),
						'live'        => true,
						'default'     => null, // this should be set by the theme (previously 40)
						'input_attrs' => array(
							'min'          => 0,
					...
					'header_title_colors_section'     => array(
						'type' => 'html',
						'html' => '<span id="section-title-header-colors" class="separator section label large">&#x1f3a8; ' . esc_html__( 'Colors', 'noto' ) . '</span>',
					),
					'header_navigation_links_color'   => array(
						'type'    => 'color',
						'label'   => esc_html__( 'Navigation Links Color', 'noto' ),
						'live'    => true,
					...
					'header_links_active_color'       => array(
						'type'    => 'color',
						'label'   => esc_html__( 'Links Active Color', 'noto' ),
						'live'    => true,
					...
					'header_links_active_style'       => array(
						'type'    => 'select',
						'label'   => esc_html__( 'Links Active Style', 'noto' ),
						'desc'    => '',
						'default' => null, // this should be set by the theme (previously active)
						'choices' => array(
							'active'    => esc_html__( 'Active', 'noto' ),
							'underline' => esc_html__( 'Underline', 'noto' ),
						),
					),
					'header_background'               => array(
						'type'    => 'color',
						'label'   => esc_html__( 'Header Background', 'noto' ),
						'live'    => true,
					...
					'header_title_fonts_section'      => array(
						'type' => 'html',
						'html' => '<span id="section-title-header-fonts" class="separator section label large">&#x1f4dd;  ' . esc_html__( 'Fonts', 'noto' ) . '</span>',
					),

					'header_site_title_font'          => array(
						'type'        => 'font',
						'label'       => esc_html__( 'Site Title Font', 'noto' ),
						'desc'        => '',
						'selector'    => '.site-title',
					...
					'header_navigation_font'          => array(
						'type'        => 'font',
						'label'       => esc_html__( 'Navigation Text', 'noto' ),
						'desc'        => '',
						'selector'    => '.c-navbar',
						'callback'    => 'typeline_font_cb',
