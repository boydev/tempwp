...
class Pixelgrade_Footer_Customizer extends Pixelgrade_Singleton {
	...
	public function addCustomifyOptions( $options ) {
		$footer_section = array(
			// Footer
			'footer_section' => array(
				'title'   => esc_html__( 'Footer', 'noto' ),
				'options' => array(
					'footer_options_customizer_tabs' => array(
						'type' => 'html',
						'html' => '<nav class="section-navigation  js-section-navigation">
							<a href="#section-title-footer-layout">' . esc_html__( 'Layout', 'noto' ) . '</a>
							<a href="#section-title-footer-colors">' . esc_html__( 'Colors', 'noto' ) . '</a>
							</nav>',
					),
					...
					'footer_title_layout_section'    => array(
						'type' => 'html',
						'html' => '<span id="section-title-footer-layout" class="separator section label large">&#x1f4d0; ' . esc_html__( 'Layout', 'noto' ) . '</span>',
					),
					'copyright_text'                 => array(
						'type'              => 'textarea',
						'label'             => esc_html__( 'Copyright Text', 'noto' ),
						'desc'              => esc_html__( 'Set the text that will appear in the footer area. Use %year% to display the current year.', 'noto' ),
						// This should be defined by the theme
						// Previously: sprintf( esc_html__( '%%year%% &copy; Handcrafted with love by the %1$s Team', 'noto' ), '<a href="https://pixelgrade.com/" rel="designer">Pixelgrade</a>' ),
						'default'           => null,
					...
					'footer_top_spacing'             => array(
						'type'        => 'range',
						'label'       => esc_html__( 'Top Spacing', 'noto' ),
						'desc'        => '',
						'live'        => true,
					...
					'footer_bottom_spacing'          => array(
						'type'        => 'range',
						'label'       => esc_html__( 'Bottom Spacing', 'noto' ),
						'desc'        => '',
						'live'        => true,
						'default'     => null, // this should be set by the theme (previously 84)
						'input_attrs' => array(
					...
					'footer_hide_back_to_top_link'   => array(
						'type'    => 'checkbox',
						'label'   => esc_html__( 'Hide "Back To Top" Link', 'noto' ),
						'default' => null, // this should be set by the theme (previously 1)
					),
					'footer_hide_credits'            => array(
						'type'    => 'checkbox',
						'label'   => esc_html__( 'Hide Pixelgrade Credits', 'noto' ),
						'default' => null, // this should be set by the theme
					),
					'footer_layout'                  => array(
						'type'    => 'select',
						'label'   => esc_html__( '"Footer Area" Widgets Layout', 'noto' ),
						'desc'    => esc_html__( 'Choose if you want the footer widgets stack into one column or spread to a row.', 'noto' ),
						'default' => null, // this should be set by the theme (previously row)
						'choices' => array(
							'stacked' => esc_html__( 'Stacked', 'noto' ),
							'row'     => esc_html__( 'Row', 'noto' ),
						),
					),
					...
					'footer_title_colors_section'    => array(
						'type' => 'html',
						'html' => '<span id="section-title-footer-colors" class="separator section label large">&#x1f3a8; ' . esc_html__( 'Colors', 'noto' ) . '</span>',
					),
					...
					'footer_links_color'             => array(
						'type'    => 'color',
						'label'   => esc_html__( 'Links Color', 'noto' ),
						'live'    => true,
					...
					'footer_background'              => array(
						'type'    => 'color',
						'label'   => esc_html__( 'Footer Background', 'noto' ),
						'live'    => true,
