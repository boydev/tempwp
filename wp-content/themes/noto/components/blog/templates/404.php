				...
				<div class="o-layout">
					<section class="error-404  not-found  o-layout__full">
						...
						<div class="entry-content u-content-width">
							<h1 class="entry-title <?php echo esc_attr( $visibility_class ); ?>"><?php esc_html_e( 'Oops! This page can&rsquo;t be found anywhere.', 'noto' ); ?></h1>
							<p><?php esc_html_e( 'It looks like nothing was found at this location. Maybe try one of the links below or a search?', 'noto' ); ?></p>
							<?php get_search_form(); ?>
						</div><!-- .entry-content -->
