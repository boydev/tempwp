...
/******/ 	return __webpack_require__(__webpack_require__.s = "./variations/noto/ts/App.ts");
/******/ })
/************************************************************************/
/******/ ({
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Noto__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Noto */ "./variations/noto/ts/Noto.ts");

new _Noto__WEBPACK_IMPORTED_MODULE_0__["Noto"]();
...
/*!**************************************!*\
  !*** ./variations/noto/ts/Header.ts ***!
  \**************************************/
/*! exports provided: NotoHeader */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NotoHeader", function() { return NotoHeader; });
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "jquery");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var imagesloaded__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! imagesloaded */ "imagesloaded");
/* harmony import */ var imagesloaded__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(imagesloaded__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _components_base_ts_models_DefaultComponent__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../components/base/ts/models/DefaultComponent */ "./components/base/ts/models/DefaultComponent.ts");
...
/* harmony import */ var _components_base_ts_services_window_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../components/base/ts/services/window.service */ "./components/base/ts/services/window.service.ts");
...
function (_BaseComponent) {
  ...
  function NotoHeader() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(NotoHeader).call(this));
    _this.$body = jquery__WEBPACK_IMPORTED_MODULE_0___default()('body');
    _this.$document = jquery__WEBPACK_IMPORTED_MODULE_0___default()(document); // private documentHeight = $( document ).height();

    _this.windowHeight = jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).height();
    _this.adminBarHeight = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#wpadminbar').outerHeight() || 0;
    _this.footerPinned = false;
    _this.headerPinned = true;
    _this.lastScroll = -1;
    _this.latestScroll = 0;
    _this.timeline = new gsap__WEBPACK_IMPORTED_MODULE_5__["TimelineMax"]({
      paused: true
    });
    _this.$headerGrid = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.c-noto--header');
    ...
    _this.$bodyGrid = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.c-noto--body');
    _this.$footer = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.site-footer');
    ...
    _this.$mainMenu = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.c-navbar__zone--left .menu');
    ...
    imagesloaded__WEBPACK_IMPORTED_MODULE_1__(jquery__WEBPACK_IMPORTED_MODULE_0___default()('.c-navbar .c-logo'), function () {
      that.bindEvents();
      that.eventHandlers();
      that.onResize();
  ...
  _createClass(NotoHeader, [{
    ...
    value: function bindEvents() {
      ...
      this.$mainMenuItems.filter('.menu-item-has-children').on('mouseenter', function () {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.c-navbar__zone--right').addClass('is-hidden');
      });
      this.$mainMenuItems.filter('.menu-item-has-children').on('mouseleave', function () {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.c-navbar__zone--right').removeClass('is-hidden');
      });
      var $accentLayer = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.c-footer-layers__accent');
      var $darkLayer = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.c-footer-layers__dark').css('opacity', 1);
      ...
      this.timeline.to(jquery__WEBPACK_IMPORTED_MODULE_0___default()('.c-navbar__zone--right'), .5, {
        opacity: 0
      }, 0);
      this.timeline.to(jquery__WEBPACK_IMPORTED_MODULE_0___default()('.c-noto--header'), 0, {
        opacity: 0
      }, 1);
      this.timeline.to($darkLayer, 1, {
        rotation: 1
      ...
      _components_base_ts_services_window_service__WEBPACK_IMPORTED_MODULE_4__["WindowService"].onScroll().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeWhile"])(function () {
        return _this2.subscriptionActive;
      })).subscribe(function () {
        _this2.latestScroll = window.scrollY;
      });
      _components_base_ts_services_window_service__WEBPACK_IMPORTED_MODULE_4__["WindowService"].onResize().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeWhile"])(function () {
        return _this2.subscriptionActive;
      })).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["debounceTime"])(200)).subscribe(function () {
        _this2.onResize();
      });
      this.bindObserver();
    }
    ...
    value: function bindObserver() {
      if ('MutationObserver' in window) {
        var target = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.site-title')[0];
        var config = {
          attributes: false,
          childList: true,
          subtree: false
    ...
    value: function pinFooter(scroll) {
      ...
      if (scroll >= this.footerOffset.top - space) {
        if (!this.footerPinned) {
          gsap__WEBPACK_IMPORTED_MODULE_5__["TweenLite"].set(that.$bodyGrid, {
            marginBottom: 0
          });
          gsap__WEBPACK_IMPORTED_MODULE_5__["TweenLite"].set(that.$footer, {
            position: 'static'
          });
    ...
    value: function pinHeader(scroll) {
      if (scroll >= 25) {
        if (!this.headerPinned) {
          gsap__WEBPACK_IMPORTED_MODULE_5__["TweenLite"].set(this.$headerGrid, {
            pointerEvents: 'none',
            zIndex: 100
          });
    ...
    value: function eventHandlers() {
      if (_components_base_ts_services_Helper__WEBPACK_IMPORTED_MODULE_3__["Helper"].below('lap') && !this.areMobileBindingsDone) {
        this.$document.on('click', this.preventOneSelector, this.onMobileMenuExpand.bind(this));
        this.areMobileBindingsDone = true;
      }

      if (_components_base_ts_services_Helper__WEBPACK_IMPORTED_MODULE_3__["Helper"].above('lap') && this.areMobileBindingsDone) {
    ...
    value: function updateSiteTitleSize() {
      var $title = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.site-title');
      $title.css('fontSize', '');
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.c-navbar__zone--middle').css('opacity', 1);
    }
  }, {
    key: "onResize",
    value: function onResize() {
      ...
      if (_components_base_ts_services_Helper__WEBPACK_IMPORTED_MODULE_3__["Helper"].below('lap')) {
    ...
    value: function prepareDesktopMenuMarkup() {
      ...
      this.windowHeight = jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).height();
      this.adminBarHeight = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#wpadminbar').outerHeight() || 0;
      this.$headerGrid.css({
  ...
  return NotoHeader;
}(_components_base_ts_models_DefaultComponent__WEBPACK_IMPORTED_MODULE_2__["BaseComponent"]);
...
/*!************************************!*\
  !*** ./variations/noto/ts/Noto.ts ***!
  \************************************/
/*! exports provided: Noto */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Noto", function() { return Noto; });
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "jquery");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _components_base_ts_BaseTheme__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../components/base/ts/BaseTheme */ "./components/base/ts/BaseTheme.ts");
/* harmony import */ var _components_base_ts_services_Helper__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../components/base/ts/services/Helper */ "./components/base/ts/services/Helper.ts");
/* harmony import */ var _components_base_ts_components_SearchOverlay__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../components/base/ts/components/SearchOverlay */ "./components/base/ts/components/SearchOverlay.ts");
/* harmony import */ var _components_base_ts_components_ProgressBar__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../components/base/ts/components/ProgressBar */ "./components/base/ts/components/ProgressBar.ts");
/* harmony import */ var _Header__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Header */ "./variations/noto/ts/Header.ts");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function (_BaseTheme) {
  ...
  function Noto() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Noto).call(this));
    _this.mouseX = 0;
    _this.mouseY = 0;
  ...
  _createClass(Noto, [{
    ...
    value: function initMobileNavigation() {
      var $nav = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div class="c-navbar__content">');
      var $shadow = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div class="c-navbar__shadow">');
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.c-navbar__zone--left, .c-navbar__zone--right').clone().appendTo($nav);
      $nav.appendTo('.c-noto');
    ...
    value: function initProgressBar() {
      var content = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.content-area');

      if (content.length) {
        var contentAreaHeight = content.outerHeight();
        var offsetTop = content.offset().top;
        this.ProgressBar = new _components_base_ts_components_ProgressBar__WEBPACK_IMPORTED_MODULE_4__["ProgressBar"]({
          canShow: true,
    ...
    value: function adjustPostsMargins() {
      ...
      for (var p = 0; p < $posts.length; p++) {
        ...
        if (p % 12 === 8 || p % 12 === 9) {
          $target = jquery__WEBPACK_IMPORTED_MODULE_0___default()($posts.get(p - 4));
        ...
        if (p > 1 && p % 12 === 1) {
          $target = jquery__WEBPACK_IMPORTED_MODULE_0___default()($posts.get(p - 3));
        ...
        if (p > 4 && p % 12 === 4) {
          $target = jquery__WEBPACK_IMPORTED_MODULE_0___default()($posts.get(p - 5));
    ...
    key: "bindEvents",
    value: function bindEvents() {
      _get(_getPrototypeOf(Noto.prototype), "bindEvents", this).call(this);
    ...
    value: function updateFocusedCard() {
      if (this.newFocusedCard) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.c-noto__item, .c-navbar__zone--middle').removeClass('has-focus has-no-focus');

        if (this.focusedCard) {
          jquery__WEBPACK_IMPORTED_MODULE_0___default()('.c-noto__item').not(this.focusedCard).addClass('has-no-focus');
          jquery__WEBPACK_IMPORTED_MODULE_0___default()('.c-navbar__zone--middle').addClass('has-no-focus');
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.focusedCard).addClass('has-focus');
        }
    ...
    key: "onLoadAction",
    value: function onLoadAction() {
      _get(_getPrototypeOf(Noto.prototype), "onLoadAction", this).call(this);

      this.SearchOverlay = new _components_base_ts_components_SearchOverlay__WEBPACK_IMPORTED_MODULE_3__["SearchOverlay"]();
      this.Header = new _Header__WEBPACK_IMPORTED_MODULE_5__["NotoHeader"]();
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.c-noto__item--post-it').addClass('is-visible');
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.c-noto__item').not('.c-noto__item--post-it').each(function (i, obj) {
    ...
    key: "onResizeAction",
    value: function onResizeAction() {
      _get(_getPrototypeOf(Noto.prototype), "onResizeAction", this).call(this);
    ...
    value: function getDecoration() {
      ...
      return jquery__WEBPACK_IMPORTED_MODULE_0___default()(selector).clone().removeClass(className);
    }
  }, {
    key: "addDecorations",
    ...
    value: function appendSvgToSeparator() {
      ...
      $container.find('hr.decoration').each(function (i, obj) {
        var $target = jquery__WEBPACK_IMPORTED_MODULE_0___default()(obj);
    ...
    value: function handleContent() {
      ...
      _components_base_ts_services_Helper__WEBPACK_IMPORTED_MODULE_2__["Helper"].wrapEmbeds($container.find('.entry-content'));
      _components_base_ts_services_Helper__WEBPACK_IMPORTED_MODULE_2__["Helper"].handleVideos($container);
      _components_base_ts_services_Helper__WEBPACK_IMPORTED_MODULE_2__["Helper"].handleCustomCSS($container);
      this.autoStyleIntro();
      this.addDecorations($container);
      this.eventHandlers($container);
      this.insertWidgetsBetweenPosts($container);
      $container.find('.sharedaddy').each(function (i, obj) {
        var $sharedaddy = jquery__WEBPACK_IMPORTED_MODULE_0___default()(obj);
  ...
  return Noto;
}(_components_base_ts_BaseTheme__WEBPACK_IMPORTED_MODULE_1__["BaseTheme"]);
